  ...
  return (
    <PageContainer>
      <div className="p-5 pb-8 space-y-6">
        ...
        <SoftCard className="bg-[#8EEA7A]/20 border-none">
          <div className="flex items-center gap-3 mb-3">
            <Heart className="text-[#58C85A]" fill="#8EEA7A" />
            <h2 className="text-lg font-bold">오늘 내 온도 기록하기</h2>
          </div>
          {hasCheckedIn ? (
            <div className="text-sm font-medium text-[#222222]">오늘의 체크인이 완료되었습니다.</div>
          ) : (
            <>
              <p className="text-sm text-[#555555] mb-4">지금 선생님의 마음 온도는 몇 도인가요?</p>
              <button
                onClick={() => router.push("/check-in")}
                className="w-full py-3 bg-white text-[#222222] rounded-xl font-bold text-sm shadow-sm border border-[#E5F5E1]"
              >
                30초 체크인 시작하기
              </button>
            </>
        ...
        <div className="relative">
          <SoftCard>
            <div className="flex items-start justify-between mb-2">
              <h2 className="font-bold text-[#222222]">이번 주 {profile.schoolLevel} 전국 평균 온도</h2>
        ...
        <SoftCard className={cn("border", riskStatus !== "stable" ? "bg-amber-50/30" : "")}>
          <div className="flex items-start justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-bold text-[#222222]">회복 신호 분석</h2>
            </div>
        ...
        <SoftCard>
          <div className="flex items-center gap-2 mb-3">
            <Sparkles className="text-[#58C85A]" size={18} />
            <h2 className="font-bold text-[#222222]">오늘의 5분 케어 추천</h2>
          </div>
          <ul className="text-sm text-[#555555] space-y-1.5 mb-4 list-disc list-inside ml-4">
            <li>퇴근 전 5분 호흡 루틴</li>
          ...
          <button
            ...
            className="w-full py-2.5 bg-[#F7FFF4] text-[#58C85A] rounded-xl font-bold text-sm hover:bg-[#EFFFF0] transition-colors"
          >
            5분 케어 시작하기
          </button>
        </SoftCard>
        ...
        <SoftCard>
          <div className="flex items-center gap-2 mb-2">
            <ShieldAlert className="text-[#222222]" size={18} />
            <h2 className="font-bold text-[#222222]">민원 대응 가이드</h2>
          </div>
          <p className="text-sm text-[#777777] mb-4">기록된 민원 내용을 바탕으로 AI 대응 가이드를 생성합니다.</p>
          <div className="flex gap-2">
            <button
              onClick={() => router.push("/complaints/new")}
              className="flex-[2] py-2.5 bg-[#222222] text-white rounded-xl font-bold text-sm"
            >
              새 민원 기록하기
            </button>
            <button
              onClick={() => router.push("/complaints")}
              className="flex-1 py-2.5 border border-[#222222] text-[#222222] rounded-xl font-bold text-sm"
            >
              기록함 보기
            </button>
          </div>
