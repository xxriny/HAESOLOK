  ...
  return (
    <PageContainer>
      ...
      <div className="p-4 space-y-6 pb-24">
        ...
        {/* Insight card */}
        <SoftCard className="bg-secondary border-primary shadow-sm">
          <div className="flex items-start gap-3">
            <div className="bg-primary p-2 rounded-full mt-0.5">
              <Lightbulb size={20} className="text-white" />
            </div>
            <div>
              <h3 className="font-bold text-foreground mb-1">최근 2주간 마음 온도가 조금 낮아졌어요.</h3>
        ...
        {/* Line chart */}
        <div>
          <h2 className="text-lg font-bold text-foreground mb-3 px-1">최근 14일 온도 변화</h2>
        ...
        {/* Monthly bar chart */}
        <div>
          <h2 className="text-lg font-bold text-foreground mb-3 px-1">월별 평균 온도</h2>
          <SoftCard className="p-3">
            <div className="h-[250px] w-full">
